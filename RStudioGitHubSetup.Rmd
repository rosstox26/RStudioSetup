...
- the option 'Enable version control interface for RStudio Projects' is checked.
...
It is important to note that RStudio's Git/GitHub functionality is tied to the idea of a "project". Each project has 
